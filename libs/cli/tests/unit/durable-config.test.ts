...
describe('durable user configuration', () => {
  it('resolves platform paths and makes the config-home override fully isolated', () => {
    ...
    expect(
      ...
      globalLockFile: '/workspace/.isolated/state/global/skill-sync.lock.json',
      globalManifestFile: '/workspace/.isolated/state/global/skill-sync.json',
      globalStateDirectory: '/workspace/.isolated/state/global',
